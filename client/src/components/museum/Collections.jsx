        ...
        <section id="Collections" className="py-20 bg-neutral-900 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-neutral-800 rounded-lg p-6 transition-transform duration-300 hover:transform hover:scale-105 animate__animated animate__fadeInUp">
                        <div className="h-48 bg-neutral-700 rounded-lg mb-4 flex items-center justify-center">
                            <svg className="w-20 h-20 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
