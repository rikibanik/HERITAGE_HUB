                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-neutral-50 p-6 rounded-lg shadow-sm">
                            ...
                            <div className="text-neutral-600">
                                <p>Phone: <a href="tel:5422595095" className="hover:text-amber-600">{MuseumData.venue.phNo}</a></p>
                                <p>Email: <a href="mailto:info@sarnathmuseum.com" className="hover:text-amber-600">{MuseumData.venue.email}</a></p>
                            </div>
                        </div>
                        {/* </div> */}
                    </div>
                        ...
                        <div className="bg-neutral-50 rounded-lg p-8 shadow-lg animate__animated animate__fadeInLeft">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center border-b border-neutral-200 pb-4">
                                    ...
                                    <span className="text-lg font-bold text-amber-600">₹{MuseumData.venue.fare.indianAdult}</span>
                                </div>
                                <div className="flex justify-between items-center border-b border-neutral-200 pb-4">
                                    <span className="text-neutral-700 font-medium">Indian Children</span>
                                    <span className="text-lg font-bold text-amber-600">₹{MuseumData.venue.fare.indianChild}</span>
                                </div>
                                <div className="flex justify-between items-center border-b border-neutral-200 pb-4">
                                    <span className="text-neutral-700 font-medium">Foreign Adults</span>
                                    <span className="text-lg font-bold text-amber-600">₹{MuseumData.venue.fare.foreignAdult}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-neutral-700 font-medium">Foreign Children</span>
                                    <span className="text-lg font-bold text-amber-600">₹{MuseumData.venue.fare.foreignChild}</span>
                                </div>
                            </div>
                        </div>

                        <div className="bg-neutral-50 rounded-lg p-8 shadow-lg animate__animated animate__fadeInRight">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-neutral-600">{MuseumData.venue.workingHours.opening.hour}:{MuseumData.venue.workingHours.opening.minute} AM - {MuseumData.venue.workingHours.closing.hour}:{MuseumData.venue.workingHours.closing.minute} PM</p>
                                    </div>
                                </div>
                                        ...
                                        <div className="text-neutral-600 flex gap-2 flex-wrap mt-1">
                                            {week.map((week, index) => {
                                                return (
                                                    ...
                                                    ${MuseumData.venue.workingsDays.includes(week) ? "bg-blue-500" : "bg-gray-500"} text-white text-sm font-bold rounded-full`}>
                                                        {week.slice(0, 2)}
                                                    </div>
                                                )
                                            })}
                            ...
                            <div className="mt-8 text-center">
                                <a href="#BookingForm" className="inline-block bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 px-8 rounded-lg transition duration-300">
                                    Book Your Visit
                                </a>
                            </div>
                        </div>
